...
public class LoadingController: BaseController {
    ...
    public convenience init(loadingLogo: UIImage? = BaseUIKitResource.loadingLogo, progressTitle: String = BaseUIKitResource.loadingProgressTitle, timeout: Double = 30) {
        self.init()
...
extension LoadingController {
    ...
    public func completeAnimation(completion: ((Bool) -> Void)? = nil) {
        ...
        UIView.animate(withDuration: duration, animations: {
            ...
            self.progressLabel.text = BaseUIKitResource.loadingFinishTitle
