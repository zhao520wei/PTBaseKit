...
extension UIControl: SelfAware {
    ...
    var ignoreEvent: Bool {
        ...
        set {
            objc_setAssociatedObject(self, &ignoreEventKey, newValue, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    ...
    @objc dynamic private func o_sendAction(_ action: Selector, to target: AnyObject, for event: UIEvent) {
    ...
    @objc dynamic private func setMz_ignoreEvent() {
